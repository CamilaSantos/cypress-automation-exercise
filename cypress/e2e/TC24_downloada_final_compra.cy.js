describe("Test Case 24 - Realizar download da fatura ao finalizar a compra", () => {
  ...
  it("Finalizar uma compra e realizar download da fatura", () => {
        ...
        cy.get('#success_message').should('contain.text', 'Your order has been placed successfully!');
        ...
        cy.get('a[href="/download_invoice/359"]').should('contain.text', 'Download Invoice').click();
